...
#define LT_GAME2 LT(U_GAME2, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [U_FUN] = LAYOUT(
        ...
        KC_NO,   KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS,                       KC_NO,   TD_FUN,  TD_MEDIA,KC_NO,   KC_NO,   KC_SLEEP,
    ...
    [U_GAME] = LAYOUT(
        ...
        KC_ESC,  KC_LCTL, KC_Z,    KC_S,    KC_C,    KC_V,                          KC_NO,   KC_NO,   KC_DOWN, KC_NO,   KC_LCTL, TD_BASE,
                                            KC_LALT, KC_SPC,  LT_GAME2,   MO_GAME2, KC_SPC,  KC_LALT
    ),
    [U_GAME2] = LAYOUT(
        ...
        KC_B,    KC_G,    KC_J,    KC_I,    KC_M,    KC_T,                          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_NO,
                                            KC_NO,   KC_NO,   KC_NO,      MO_GAME2, KC_BSPC, KC_DEL
    )
};
